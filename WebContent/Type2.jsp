...
<title>Attempt Type 2 Question</title>
...
<input type="hidden" name="qnumber" value="2" size="20">
...
session.setAttribute("Qorder", ord-1);
  ...
  session.setAttribute("reject", rej+",Type2"); 
%>
...
<br>
<table><tr><td valign='top'><b>&nbsp;Type2. </td><td valign='top'><b> Select two prime numbers .<b></td></tr>
</table><br>
<table border='0'>
<tr><td valign='top'><input type="checkbox" name='quiz' id='1' value='1' /></td><td><label for='1'>1</label></td></tr>
<tr><td valign='top'><input type="checkbox" name='quiz' id='2' value='2' /></td><td><label for='2'>2</label></td></tr>
<tr><td valign='top'><input type="checkbox" name='quiz' id='3' value='3' /></td><td><label for='4'>3</label></td></tr>
<tr><td valign='top'><input type="checkbox" name='quiz' id='4' value='4' /></td><td><label for='3'>4</label></td></tr>
</table>
<br>
